...
import { removeChoice } from 'features/offers/dishes/actions';

import { Box, Button, Collapse, IconButton, Paper, Stack } from '@mui/material';
import ChoiceSubs from './ChoiceSubs';
import EditChoice from './EditChoice';
import SetSubsModal from 'features/offers/choices/components/SetSubsModal/SetSubsModal';
...
function Choice({ choiceId, dish }) {
  ...
  const choice = useSelector((state) => state.offers.choices.byId[choiceId]);
