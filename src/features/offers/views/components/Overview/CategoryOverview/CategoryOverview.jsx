...
import DeleteCategory from 'features/offers/categories/components/DeleteCategory';
...
function CategoryOverview() {
  const categoriesArray = useSelector((state) => {
    let categoriesArray = Object.values(state.offers.categories.byId);
    categoriesArray.sort((a, b) => a.name.localeCompare(b.name));
    return categoriesArray;
  });
  const selectedCategoryId = useSelector((state) => state.offers.views.itemId);
