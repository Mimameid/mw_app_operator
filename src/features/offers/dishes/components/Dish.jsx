...
import { removeDish } from 'features/offers/categories/actions';

import { Box, Button, Chip, Collapse, Grid, IconButton } from '@mui/material';
import DishChoices from 'features/offers/dishes/components/DishChoices';
import EditDish from './EditDish';
import SetChoicesModal from 'features/offers/dishes/components/SetChoicesModal/SetChoicesModal';
...
function Dish({ dishId, category }) {
  ...
  const dish = useSelector((state) => state.offers.dishes.byId[dishId]);
