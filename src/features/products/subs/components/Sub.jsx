...
import { removeSub } from 'features/products/choices/actions';
    ...
    <Grid sx={{ p: choice ? 1 : 2 }} container alignItems="center">
      <Grid item>
        ...
        <Box sx={{ pl: 1 }} display="inline-block">
          <IconButton aria-label="edit product" size="small" onClick={handleEditSub}>
            <Edit fontSize="small" />
          </IconButton>
          {choice ? (
            <IconButton aria-label="delete product" size="small" onClick={handleRemoveSub}>
