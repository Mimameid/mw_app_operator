...
import { removeChoice } from 'features/products/products/actions';

import { Box, Button, Collapse, IconButton, Paper, Stack } from '@mui/material';
import ChoiceSubs from './ChoiceSubs';
import EditChoice from './EditChoice';
import SetSubsModal from 'features/products/choices/components/SetSubsModal/SetSubsModal';
...
function Choice({ choiceId, product }) {
  ...
  const handleRemoveChoice = (event) => {
    dispatch(removeChoice({ choiceId, productId: product.id }));
  };
